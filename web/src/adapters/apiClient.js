...
function mapSelfhostPath(path) {
  ...
  const mappings = [
    ...
    [/^\/credentials\/platform\/manual(\?.*)?$/, '/credentials/platform/manual$1'],
    [/^\/credentials\/platform\/validate(\?.*)?$/, '/credentials/platform/validate$1'],
    [/^\/credentials\/meta\/pages(\?.*)?$/, '/credentials/meta/pages$1'],
