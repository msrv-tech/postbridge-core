...
from postbridge.integrations.x.credentials import decode_channel_credentials
from postbridge.integrations.x.publisher import XPublisher
from postbridge.integrations.x.rule_post_text import (
    X_TEXT_LIMIT,
    adapt_post_dict as x_rule_adapt_post,
)
...
def make_registration(default_ai: PlatformAiAdapter) -> PlatformRegistration:
    return PlatformRegistration(
        ...
        bundle=PlatformBundle(
            ...
            rule_adapt_post=x_rule_adapt_post,
        ),
        rule_post_text_limit=X_TEXT_LIMIT,
    )
