...
from postbridge.integrations.instagram.credentials import decode_channel_credentials
from postbridge.integrations.instagram.publisher import InstagramPublisher
from postbridge.integrations.instagram.rule_post_text import (
    INSTAGRAM_CAPTION_LIMIT,
    adapt_post_dict as instagram_rule_adapt_post,
)
...
def make_registration(default_ai: PlatformAiAdapter) -> PlatformRegistration:
    return PlatformRegistration(
        key="instagram",
        fetcher_cls=None,
        publisher_cls=InstagramPublisher,
        bundle=PlatformBundle(
            ...
            rule_adapt_post=instagram_rule_adapt_post,
        ),
        rule_post_text_limit=INSTAGRAM_CAPTION_LIMIT,
    )
