...
from postbridge.integrations.mastodon.credentials import decode_channel_credentials
from postbridge.integrations.mastodon.publisher import MastodonPublisher
from postbridge.integrations.mastodon.rule_post_text import (
    MASTODON_TEXT_LIMIT,
    adapt_post_dict as mastodon_rule_adapt_post,
)
...
def make_registration(default_ai: PlatformAiAdapter) -> PlatformRegistration:
    return PlatformRegistration(
        key="mastodon",
        fetcher_cls=None,
        publisher_cls=MastodonPublisher,
        bundle=PlatformBundle(
            ...
            rule_adapt_post=mastodon_rule_adapt_post,
        ),
        rule_post_text_limit=MASTODON_TEXT_LIMIT,
    )
